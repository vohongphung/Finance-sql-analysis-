...
The project simulates a simple finance tracking system.  
You can record users, accounts, categories, and transactions, then analyze spending or income patterns.
...
git clone [Finance-sql-analysis-](https://github.com/vohongphung/Finance-sql-analysis-)
2.	Run setup
